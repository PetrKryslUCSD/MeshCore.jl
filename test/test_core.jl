...
function test()
    ...
    @test coordinates(locs, facemesh(17)) == StaticArrays.SArray{Tuple{2},Float64,1,2}[[1900.0, 800.0], [1266.6666666666667, 800.0]]
    @test coordinates(locs, facemesh(17)[1]) == [1900.0, 800.0]
    true
end
end
using .mtest6
